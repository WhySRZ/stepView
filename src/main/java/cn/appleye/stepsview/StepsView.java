...
public class StepsView extends FrameLayout{
    ...
    public StepsView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStepTextSize = typedArray.getDimensionPixelSize(R.styleable.steps_view_text_size, mStepTextSize);
        mStepNormalTextColor = typedArray.getColor(R.styleable.steps_view_text_color, 0xffffffff);
        mSplitLineWidth = typedArray.getDimensionPixelSize(R.styleable.steps_view_split_line_width, mSplitLineWidth);
        typedArray.recycle();
...
//        mStepTextSize = DisplayUtil.sp2px(context, 18);
    ...
    private void initViews(){
        ...
        for(int i=0; i<mStepsCount; i++) {
            ...
            //默认第一个步骤为正在处理
            if(i==0) {
                stepView.setImageResource(R.drawable.ic_label_now);
                stepView.setTextColor(mStepTextColor);
            } else {
                stepView.setImageResource(R.drawable.ic_label_normal);
    ...
    private void updateStepStatus(int stepIndex) {
        ...
        for(int i=0; i<stepIndex; i++) {
            ...
            stepImageView.setImageResource(R.drawable.ic_label_complete);
        ...
        for(int i=stepIndex+1; i<mStepsCount; i++) {
            TextImageView stepImageView = mStepViews.get(i);
            stepImageView.setImageResource(R.drawable.ic_label_normal);
        ...
        stepImageView.setImageResource(R.drawable.ic_label_now);
